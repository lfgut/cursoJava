...
public class Cliente extends Persona {
	...
	*/
	...
	//	varables y métodos estáticos: son de la clase y no hace falta instanciar un objeto para usarlos
	...
	public Cliente(String nombre, String apellido, String profesion, int edad, String ciudad) {
	...
	public String toString() {
		return super.toString() + salto +"ClienteID: " + ClienteID;
	}
